...
ADD https://github.com/gohugoio/hugo/releases/download/v0.146.3/hugo_0.146.3_Linux-64bit.tar.gz hugo.tar.gz
RUN echo "e071590c7c57ad3394bdf07c24db22c965d578bd0712e926c26fc60868798f7b  hugo.tar.gz" | sha256sum -c
